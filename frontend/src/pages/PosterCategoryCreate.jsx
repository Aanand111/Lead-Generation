...
const PosterCategoryCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await api.post('/admin/poster-categories', formData);
            if (res.data.success) {
        ...
        <div className="page-content animate-fade-in text-[var(--text-dark)] pb-10">
            ...
            <div className="pageHeader">
                <div className="pageHeaderTitle">
                    ...
                    <p>Define a new classification for visual assets</p>
                </div>
...
export default PosterCategoryCreate;
