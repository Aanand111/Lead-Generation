...
const CustomerCreate = () => {
    ...
    const citiesByState = {
        ...
        "Haryana": ["Faridabad", "Gurugram", "Panipat", "Ambala", "Yamunanagar", "Rohtak", "Hisar", "Karnal", "Sonipat", "Panchkula", "Bhiwani", "Bahadurgarh","Palwal","Fatehabad", "Jind", "Sirsa",],
        "Himachal Pradesh": ["Shimla", "Dharamshala", "Solan", "Mandi", "Palampur", "Baddi", "Nahan", "Hamirpur", "Una", "Bilaspur", "Chamba", "Kullu", "Manali" , "Kasauli", "Narkanda", "Kaza", "Keylong", "Kinnaur", "Sirmour", "Kangra", "Hamirpur", "Una", "Bilaspur", "Chamba", "Kullu", "Manali", "Kasauli", "Narkanda", "Kaza", "Keylong", "Kinnaur", "Sirmour", "Kangra",],
        "Jharkhand": ["Jamshedpur", "Dhanbad", "Ranchi", "Bokaro Steel City", "Deoghar", "Phusro", "Hazaribagh", "Giridih", "Ramgarh", "Medininagar", "Dumka", "Chaibasa", "Adityapur", "Chas", "Jhumri Telaiya", "Ghatshila", "Sahibganj", "Lohardaga"],
        "Karnataka": ["Bengaluru", "Mysuru", "Hubballi-Dharwad", "Mangaluru", "Belagavi", "Kalaburagi", "Davangere", "Ballari", "Vijayapura", "Shivamogga", "Shivamogga", "Tumakuru", "Raichur", "Bidar", "Udupi", "Hassan", "Hospet", "Chitradurga"] ,
        "Kerala": ["Thiruvananthapuram", "Kochi", "Kozhikode", "Kollam", "Thrissur", "Kannur", "Alappuzha", "Kottayam", "Palakkad", "Manjeri",],
        "Madhya Pradesh": ["Indore", "Bhopal", "Jabalpur", "Gwalior", "Ujjain", "Sagar", "Dewas", "Satna", "Ratlam", "Rewa", "Ratlam", "Rewa", "Katni", "Singrauli", "Khandwa", "Burhanpur", "Chhindwara", "Vidisha", "Narmadapuram", "Morena", "Itarsi"],
        "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Thane", "Pimpri-Chinchwad", "Nashik", "Kalyan-Dombivli", "Vasai-Virar City", "Aurangabad", "Navi Mumbai","Kolhapur", " "],
        "Manipur": ["Imphal", "Thoubal", "Kakching", "Ukhrul"],
        "Meghalaya": ["Shillong", "Tura", "Jowai", "Nongpoh"],
        "Mizoram": ["Aizawl", "Lunglei", "Saiha","Champhai","Kolasib","Lawngtlai","Serchhip","Hnahthial","Khawzawl","Hmawngkawn","Siaha"],
